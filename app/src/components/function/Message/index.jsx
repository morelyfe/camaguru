	...
	return (
		<div className='message'>
			<div className='message-profile' style={
				...
				:
				{ backgroundImage: 'url(\'/images/' + props.content.user_picture + '\')' }
			} onClick={() => _handleProfilePage()}></div>
			<div className='message-author' onClick={() => _handleDetail(props.content.post_id)}>{props.content.user_username}</div>
