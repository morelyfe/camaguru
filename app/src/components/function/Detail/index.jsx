		...
		<div id='detail' className='detail'>
			...
			<div className='inner-container'>
				...
				<div className='post-profile' style={
					...
					:
					{ backgroundImage: 'url(\'/images/' + content.post.user_picture + '\')' }
					...
					<img className='post-picture' src={'/images/' + content.post.picture} onLoad={ () => document.getElementById('post-load-' + content.post.id).style.display = 'none' } alt='post' />
					...
					<div className='post-reflect-container'>
						...
						{ content.isLikes && content.post.likes.length !== 0 ? 
							...
							{ content.post.likes.map((like) => 
								<Likes key={like.user_id} like={like} /> 
							)}
							</div>
						: '' }
