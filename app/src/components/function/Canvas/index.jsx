...
const Canvas = () => {
	...
	return (
		<div className='canvas'>
			...
			<div id={'canvas-sticker-' + index} className={'canvas-sticker preview-filter-' + camera.filter} style={{ backgroundImage: 'url(\'/sticker/' + input + '\')'}} key={index} onDrag={_handleDrag} onDoubleClick={() => _handleRemove()} draggable></div>	
			)}
		</div>
	);
}
