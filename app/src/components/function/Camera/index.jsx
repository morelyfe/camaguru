...
import { FiTrash2, FiUpload, FiCamera } from 'react-icons/fi';
// FiHeart
				...
				<div className='camera-post'>
					...
					<form name='camera'>
						<div className='post-info-container'>
							<div className='post-author'>{user.user.username}</div>
						...
						<div className='post-reflect-container'>
							...
							<textarea className='post-comment-box' id='camera-comment-box' name='content' placeholder='Add a story of image!' onChange={ () => _handleTextareaSize() }></textarea>
