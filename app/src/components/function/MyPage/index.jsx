			...
			<div className='inner-container'>
				<div className='mypage-header'>
					<div className='mypage-profile-container' style={
						...
						:
						{ backgroundImage: 'url(\'/images/' + search.user.picture + '\')' }
					}></div>
					<div className='mypage-profile-container'>
						<div className='mypage-profile-nickname'>{search.user.username}</div>
						...
						<textarea className='mypage-profile-bio' 
							...
							value={
								...
								? 'Hey there! I am using Camagru App!' : search.user.bio
							} 
							readOnly>
						</textarea>				
					</div>
