		...
		<div className='comments'>
			<div className='comments-container'>
				<div className='comments-profile' style={
					...
					:
					{ backgroundImage: 'url(\'/images/' + props.comment.user_picture + '\')' }
				} onClick={() => _handleProfilePage()}></div>
				<textarea className='comments-content' style={{height: props.comment.content.split('\n').length * 1.5 + 'rem'}} value={props.comment.content} readOnly></textarea>
				<div className='comment-nickname'>BY {props.comment.user_username} ({props.comment.time})</div>
